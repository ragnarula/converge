...
Present the candidate in EARS form (see the `ears_v3` skill) with the supporting evidence — the test or code excerpt that demonstrates it. Ask: *intentional, accidental, or change me?*
...
> - Every FR is a single EARS statement (see the `ears_v3` skill). The EARS sentence itself is the acceptance criterion.
