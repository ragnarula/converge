...
Use the `handbook_v3` skill to read and resolve project conventions. These conventions affect how specifications are structured.
...
You **MUST** understand project guidelines by using the `handbook_v3` skill
...
> - Every FR is a single EARS statement (see the `ears_v3` skill for patterns and combinations). The EARS sentence itself is the acceptance criterion.
...
Use the `review_v3` skill to perform a **Specification Review** of the specification at `{artifact_dir}/specification.md`.
