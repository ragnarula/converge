...
|-------|---------|---------------|
| `problem-definition_v3` | feature | `problem` |
| `problem-research_v3` | feature | `research` |
| `problem-converge_v3` / `extract-spec_v3` | feature | `specification` |
| `problem-tasks_v3` / `tasks_v3` | feature | `tasks` |
