---
name: mocking
description: Mocking rules — where test doubles are appropriate and where they aren't. Mock at system boundaries only, never your own modules. Use this when writing tests that need mocks, fakes, or stubs. Loaded by the implement skill.
version: 0.1.0
---
