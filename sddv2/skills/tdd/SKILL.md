---
name: tdd
description: Test-driven development for SDD — red-green-refactor with the dependency-count heuristic for test depth. Use this when implementing a task. Loaded by the implement skill.
version: 0.1.0
---
...
1. Read the handbook (use the `handbook` skill). It covers test file locations, fixtures, assertion style, framework, runner, and naming.
